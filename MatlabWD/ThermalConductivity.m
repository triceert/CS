...
lambdagas1 = [cmp(1).lambdagas300,cmp(1).lambdagas400,cmp(1).lambdagas500,cmp(1).lambdagas600];
...
p2 = polyfit(Tgas100,lambdagas2,1);
p3 = polyfit(Tgas100,lambdagas3,1);
p4 = polyfit(Tgas300,lambdagas4,1);

%p = polyfit(T,lambda,1)
