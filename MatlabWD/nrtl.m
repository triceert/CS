...
gamma(1) = exp(x2^2*(tau_21*((G21/(x1+x2*G21))^2)+tau_12*G12/((x2+x1*G12)^2)));   % activity coefficient of first species (HCN)
gamma(2) = exp(x1^2*(tau_12*((G12/(x2+x1*G12))^2)+tau_21*G12/((x1+x2*G21)^2)));   % activity coefficient of second species (H2O)
end
